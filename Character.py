...
class Character:
    ...
    @cached_property
    def intellect(self):
        return self._calculate_stat_value(self.intellect, Character.intellectPerPoint)

    @cached_property
    def crit(self):
        return self._calculate_stat_value(self.crit, Character.critPerPoint) + 5 #5% base crit
    
    @cached_property
    def expertise(self):
        return self._calculate_stat_value(self.expertise, Character.expertisePerPoint)
    
    @cached_property
    def haste(self):
        return self._calculate_stat_value(self.haste, Character.hastePerPoint)

    @cached_property
    def spirit(self):
        return self._calculate_stat_value(self.spirit, Character.spiritPerPoint)
